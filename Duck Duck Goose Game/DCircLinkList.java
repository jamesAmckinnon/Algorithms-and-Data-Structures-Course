/*
 * ************ I did not create this class, the DuckDuckGoose
...
public class DCircLinkList<E> {
    ...
    public void addNodeAsFirst(DNode<E> newNode) {
        if (size == 0) { // if list is empty, then this node is the only
            entry = newNode; //can't link to self until made
            entry.setPrevious(entry); // link it to itself
            entry.setNext(entry);     // circularly             
        }
        else {
    ...
    // String Reps ============================================================
    /**
     * Produces a string representation of the contents of the list. This can
     * be very useful for debugging or developing.  This string is obtained
     * by moving through the list in a clockwise direction.
    ...
    /**
     * Produces a string representation of the contents of the list. This can
     * be very useful for debugging or developing.  Produces the String by 
